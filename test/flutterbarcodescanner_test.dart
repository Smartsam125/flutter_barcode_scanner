...
void main() {
  final FlutterbarcodescannerPlatform initialPlatform =
      FlutterbarcodescannerPlatform.instance;
  ...
  test('getPlatformVersion', () async {
    ...
    MockFlutterbarcodescannerPlatform fakePlatform =
        MockFlutterbarcodescannerPlatform();
